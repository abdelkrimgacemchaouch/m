...
int main ( void );
void assemble ( float adiag[], float aleft[], float arite[], float f[], 
  float h[], int indx[], int nl, int node[], int nu, int nquad, int nsub, 
  float ul, float ur, float xn[], float xquad[] );
float ff ( float x );
void geometry ( float h[], int ibc, int indx[], int nl, int node[], int nsub, 
  int *nu, float xl, float xn[], float xquad[], float xr );
void init ( int *ibc, int *nquad, float *ul, float *ur, float *xl, 
  float *xr );
void output ( float f[], int ibc, int indx[], int nsub, int nu, float ul, 
  float ur, float xn[] );
void phi ( int il, float x, float *phii, float *phiix, float xleft, 
  float xrite );
float pp ( float x );
void prsys ( float adiag[], float aleft[], float arite[], float f[], 
  int nu );
float qq ( float x );
void solve ( float adiag[], float aleft[], float arite[], float f[], 
  int nu );
void timestamp ( void );
...
/*
  ...
  Parameters:
    ...
    float ADIAG(NU), the "diagonal" coefficients.  That is, ADIAG(I) is
    the coefficient of the I-th unknown in the I-th equation.

    float ALEFT(NU), the "left hand" coefficients.  That is, ALEFT(I) 
...
/*
  ...
  Parameters:
    ...
    Output, float FF, the value of the function.
*/
{
  float value;
...
/*
  ...
  Parameters:
    ...
    Output, float XN(0:NSUB).
    XN(I) is the location of the I-th node.  XN(0) is XL,
    and XN(NSUB) is XR.

    Output, float XQUAD(NSUB)
    XQUAD(I) is the location of the single quadrature point
    in interval I.
...
/*
  ...
  Parameters:
    ...
    Output, float *PHII, *PHIIX, the value of the
    basis function and its derivative at X.

    Input, float XLEFT, XRITE, the left and right
...
/*
  ...
  Parameters:
    ...
    Output, float PP, the value of the function.
*/
{
  float value;
...
/*
  ...
  Parameter:
    ...
    Input, float ADIAG(NU), the "diagonal" coefficients.  That is, 
    ADIAG(I) is the coefficient of the I-th unknown in the I-th equation.

    Input, float ALEFT(NU), the "left hand" coefficients.  That is, ALEFT(I) 
    is the coefficient of the (I-1)-th unknown in the I-th equation.
    There is no value in ALEFT(1), since the first equation
    does not refer to a "0-th" unknown.

    Input, float ARITE(NU).
    ARITE(I) is the "right hand" coefficient of the I-th
    equation in the linear system.  ARITE(I) is the coefficient
    of the (I+1)-th unknown in the I-th equation.  There is
    no value in ARITE(NU) because the NU-th equation does not
...
/*
  ...
  Parameters:
    ...
    Output, float QQ, the value of the function.
*/
{
  float value;
...
/*
  ...
  Parameters:
    ...
    Input/output, float ADIAG(NU), ALEFT(NU), ARITE(NU).
